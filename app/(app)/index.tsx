...
const getStyles = (colors: any, insets: any) => StyleSheet.create({
    ...
    summaryCard: { flex: 1, borderRadius: 20, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1, borderColor: colors.border + '20' },
    summaryIconWrapper: { width: 30, height: 30, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
    summaryLabel: { fontSize: 10, fontWeight: '700', color: colors.secondaryText, marginBottom: 1 },
