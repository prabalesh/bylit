...
function ContactPickerModal({ visible, onClose, onSelect, colors, insets }: ContactPickerProps) {
                    ...
                    {loading ? (
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => {
                                ...
                                return (
                                    <TouchableOpacity style={pickerStyles.item} onPress={() => { onSelect(item.name!); onClose(); }}>
                                        ...
                                        <ChevronRight size={16} color={colors.secondaryText} style={pickerStyles.arrow} />
                                    </TouchableOpacity>
                                );
                            }}
    ...
    return (
        <>
            ...
            <ContactPickerModal
                ...
                onSelect={(name) => setPersonName(name)}
                colors={activeColors}
                insets={insets}
            />
        </>
